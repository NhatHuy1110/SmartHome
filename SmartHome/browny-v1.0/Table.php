        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <td>" . $row["Presence"] . "</td>
                    <td>
                        <a class='btn btn-primary btn-sm' href='update.php?rid=" . $row["RID"] . "&datetime=" . urlencode($row["DateTime"]) . "'>Update</a>
                        <a class='btn btn-danger btn-sm' href='delete.php?rid=" . $row["RID"] . "&datetime=" . urlencode($row["DateTime"]) . "' onclick=\"return confirm('Are you sure you want to delete this record?');\">Delete</a>
                    </td>
                    </tr>";
                }
                ?>
